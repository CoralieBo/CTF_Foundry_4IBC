...
contract HackMeIfYouCan {
    ...
    function flip(bool _guess) public whenUnlocked returns (bool) { // DONE
    ...
    function addPoint() public whenUnlocked { // DONE
    ...
    function transfer(
        address _to,
        uint256 _value
    ) public whenUnlocked returns (bool) { // DONE
    ...
    function goTo(uint256 _floor) public whenUnlocked { // TODO
    ...
    function sendKey(bytes16 _key) public whenUnlocked { // DONE
    ...
    function sendPassword(bytes32 _password) public whenUnlocked { // DONE
    ...
    receive() external payable whenUnlocked { // DONE
